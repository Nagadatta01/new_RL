...
def train_baseline_single_run(run_id, num_episodes=100):
    """Train baseline - single run WITH VISUALIZATION SUPPORT"""
...
def step3a_baseline_training():
    """Step 3A: Train ONLY baseline WITH VISUALIZATION OPTION"""
...
if __name__ == "__main__":
    baseline_results = step3a_baseline_training()
